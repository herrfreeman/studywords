...
class RestorePasswordFragment : Fragment() {
    ...
    private val binding: FragmentRestorePasswordBinding get() = _binding!!
    ...
    private fun setButtonsEnable() {
        binding.restoreButton.isEnabled = !binding.userName.text.isNullOrEmpty() && !binding.password.text.isNullOrEmpty()
    }
